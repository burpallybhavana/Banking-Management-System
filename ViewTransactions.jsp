                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   ...
						   <h2><span>All Transactions <a href="ViewTransactions.jsp">Back</a></h2>
                        </div>
...
<%
    ...
    try
    {
      ...
      ResultSet rs=st.executeQuery("select * from transaction where ano='"+ano+"' and transaction='DEPOSIT'");
      while(rs.next())	
      {
       %>
       <tr>
           <td><%=rs.getString("ano")%></td>
            <td><%=rs.getString("amount")%> Rs/-</td>
...
<%
    ...
    try
    {
      Connection con=DBCon.getCon();
      Statement st=con.createStatement();
      ResultSet rs=st.executeQuery("select * from transaction where ano='"+ano+"' and transaction='WITHDRAW'");
      while(rs.next())	
      {
       %>
       <tr>
...
<%
    ...
    try
    {
      Connection con=DBCon.getCon();
      Statement st=con.createStatement();
      ResultSet rs=st.executeQuery("select * from t_transaction where fano='"+ano+"' and task='TRANSFER'");
      while(rs.next())	
      {
       %>
       <tr>
           <td><%=rs.getString("tano")%></td>
            <td><%=rs.getString("amount")%> Rs/-</td>
...
<form action="ViewTransactions.jsp" method="post">
                                                    <table>
                                                                    <tr><th>Select Action: </th><td><select name="task" required="">
                                                                                <option></option>
