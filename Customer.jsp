            ...
            <div class="row">
			    <div class="col-md-6">
                    <div class="full float-right_img">
                        <img src="img/adminLogin.gif" alt="#" />
                    </div>
                </div>
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <h2><span>Customer Login</h2>
                        </div>
						<div class="full">
                                                    <form name="login" action="CustomerLogin.jsp" method="post" onsubmit="return validate()"
                                                          <p><input type="text" name="username" placeholder="Enter user ID" required=""></p>
                                                        <p><input type="password" name="password" placeholder="Enter Password" required=""></p>
                                                        <p><input type="Submit" value="Login" ></p>
                                           </div>
						<div class="full">
						   <a class="hvr-radial-out button-theme" href="CustomerReg.jsp">Create Account</a>
						</div>
                    </div>
                </div>
			</div>
