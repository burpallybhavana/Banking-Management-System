            ...
            <div class="row">
                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
						...
						<div class="full">
 <h3> <a href="ViewHolidays.jsp">Back</a></h3>
...
<%
    ...
    try
    {
      ...
      ResultSet rs=st.executeQuery("select * from bankleave where bankname='"+bankname+"'");
      while(rs.next())	
      {
       %>
       <tr>
           <td><%=rs.getString("bankname")%></td>
            ...
            <td><a href="ViewHolidays.jsp?image_id=<%=rs.getString("id")%>"><image src="view.jsp?id=<%=rs.getString("id")%>" width="50" height="50"></a></td>
