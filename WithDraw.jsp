                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   ...
						   <h2><span>WithDraw Here</h2>
                        </div>
                        
						<div class="full">
                                                    <form name="deposit" action="WithDrawAction.jsp" method="post" onsubmit="return validate()"
...
%>
			...
			out.println(e);
			 ...
			 %>
                                                        <p><input type="text" name="amount" placeholder="Enter Amount to withdraw" required=""></p>
