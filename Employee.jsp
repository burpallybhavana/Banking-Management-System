            ...
            <div class="row">
			    <div class="col-md-6">
                    <div class="full float-right_img">
                        <img src="img/userlogin.jpg" alt="#" />
                    </div>
                </div>
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <h2><span>Employee Login</h2>
                        </div>
						<div class="full">
                                                    <form name="login" action="EmployeeLogin.jsp" method="post" onsubmit="return validate()"
						...
						<div class="full">
						   <a class="hvr-radial-out button-theme" href="EmployeeReg.jsp">Create Account</a>
						</div>
                    </div>
                </div>
			</div>
