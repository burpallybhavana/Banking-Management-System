...
<%
    ...
    try
    {
       ...
       Statement st=con.createStatement();
                 ...
                 int ii=st.executeUpdate("insert into transaction values('"+ano+"','"+username+"','"+amount+"','DEPOSIT',now())");
                 if((i>0)&&(ii>0))
                 {
                     %>
                     <script type="text/javascript">
                         window.alert("Money Deposited Sucessfully.....");
...
else
{
 %>
                     <script type="text/javascript">
                         window.alert("Unable to  Deposit Money.....");
                         window.location="ViewBalance.jsp";
                         </script>
                     <%
}
