                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   ...
						   <h2><span>Transfer Amount</h2>
                        </div>
                        
						<div class="full">
                                                    <form name="deposit" action="TransferAction.jsp" method="post" onsubmit="return validate()"
                                                    <p>FROM ACC NO : <input type="text" name="fano" value="<%=ano%>" ></p>
                                                     <p>TO ACC NO : <input type="text" name="tano" placeholder="To Acc No" required=""></p>
...
%>
			...
			out.println(e);
			 ...
			 %>
                                                        <p>Enter Amount : <input type="text" name="amount" placeholder="Enter Amount to withdraw" required=""></p>
