...
<%@page import="java.util.Random"%>
 <%
    ...
    String eid ="EMP"+String.valueOf(rand.nextInt(10))+String.valueOf(rand.nextInt(10))+String.valueOf(rand.nextInt(10)
                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <h2><span>Employee Registration</h2>
                        </div>
						<div class="full">
                                                    <form name="login" action="EmployeeRegAction.jsp" method="post" onsubmit="return validate()"
                                                          <p><input type='text'name='eid' value='<%=eid%>'></p>
...
%>
			...
			out.println(e);
			 ...
			 %>
						...
						<div class="full">
						   <a class="hvr-radial-out button-theme" href="Employee.jsp">Already Account</a>
						</div>
                    </div>
                </div>
			</div>
